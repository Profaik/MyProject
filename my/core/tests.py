...
from core.models import User, Sport_company
...
class UserTest(TestCase):
    def test_event_model_create(self):
        ...
        eventUser1 = Sport_company.objects.create(event=newEvent, user=participant1)
        eventUser2 = Sport_company.objects.create(event=newEvent, user=participant2)
